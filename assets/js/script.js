...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Lance Dsilva";
...
var typed = new Typed(".typing-text", {
    strings: ["Security operations center analyst", "Data analyst", "Python developer", "Machine learning Enthusiast","Masters student"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
